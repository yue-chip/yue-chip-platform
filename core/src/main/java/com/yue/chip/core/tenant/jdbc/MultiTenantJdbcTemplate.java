//package com.yue.chip.core.tenant.jdbc;
//
...
// */
//public class MultiTenantJdbcTemplate extends JdbcAccessor implements JdbcOperations {
//
...
//     */
//    public MultiTenantJdbcTemplate(@Autowired DataSource dataSource) {
...
//            statement.execute(TenantDatabaseUtil.getDatabaseScript());
...
//        }
//        AtomicReference<Statement> stmt = null;
//        int[][] result = execute(sql, (PreparedStatementCallback<int[][]>) ps -> {
//            List<int[]> rowsAffected = new ArrayList<>();
//            try {
//                Connection connection = ps.getConnection();
//                if (Objects.isNull(stmt.get())) {
//                    stmt.set(connection.createStatement());
//                    stmt.get().execute(TenantDatabaseUtil.getDatabaseScript());
//                }
...
//            }
//            finally {
//                JdbcUtils.closeStatement(stmt.get());
//                if (pss instanceof ParameterDisposer parameterDisposer) {
//                    parameterDisposer.cleanupParameters();
//                }
//            }
